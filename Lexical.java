...
public class Lexical {
	...
	case "Start_Program" : return false; 
	
	case ":" : return false;

	case "End_Program" : return false; 

	case "Int_Number" :	return false; 

	case "Real_Number" : return false; 

	case "ShowMes" : return false; 

	case "StringMes" : return false; 

	case "Give" : return false; 

	case "Affect" : return false; 
	...
	public  String keyWord(String line) {
		...
		case "Start_Program" : resultat =   word[i] +  ":   mot reserver de debut de programer";
                               break;

		case "End_Program" : resultat =   word[i] +  ":   mot reserver de fin de programer";
                             break;

		case "Int_Number" : resultat = word[i] + ":   mot reserver pour declaration d'un entier \n" +  lex(line);
                            break;

		case "Real_Number" : resultat =word[i] + ":   mot reserver pourdeclaration d'un reel  \n" + lex(line);
			                 break;

		case "ShowMes" : resultat =word[i]  + ":    mot reserver pour  affichage \n" + lex(line);
		                 break;

		case "StringMes" : resultat =   word[i] +  ":   mot reserver declaration d'un stringr";
			               break;

		case ";;" : resultat = word[i] + ":   mot reserver pour fin d'instruction";
			         break;

		case "//." : resultat =  word[i] + ":   mot reserver pour debut de commentaire";
                     break;

		case "--" : resultat =  " :   fin de condition";
                    break;

		case "Give" : resultat = word[i] + " :  mot reserver pour affection a d'une valeur a une variable \n" +	lex(line);
                      break;

		case "Affect" : resultat = word[i] + "    mot reserver pour affectation d'une valeur entre variable \n"+	lex(line);
                        break;

		case "If" : resultat = word[i] + "  : mot reserver pour une condition " +  snl_if(line);
                    break;
                    
		case "Else" : resultat =  word[i] +" :  le sinon de la condition ";
                      break;

		case "Start" : resultat =word[i] +  " :   mot reserve pour debut de bloc";
                       break;

		case "Finish" : resultat =word[i] +  " :   mot reserve pour fin de bloc";
			            break;	

			default : resultat =word[i] +  " :   erruer mot non reconu" +	lex(line);
                      break;
		...
		// TODO Auto-generated method stub
 		...
 		resultat = resultat + "\n" +  chaine_cara;
 				...
 				for(int k  = i +1 ; k<word.length; k++) {
  				   ...
  				   // check if the last word contain a "  in the end of the word *************
