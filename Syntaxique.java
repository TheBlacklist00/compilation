...
public class Syntaxique {
	...
	public String keyWord(String line) {
		...
		if ( word[i].isEmpty()) {
			...
			case "Give" : 
				if(Give(line)) {
					resultat = line +" :  Affectation de valeur a une variable \n" ;
				}
				else {nbr_erreur++;
					resultat = line + " :  erreur syntaxique ";
				}
			...
			case "Affect" : 
				if(get(line)) {
					resultat = line +" : Affectation a d'une variable a une variable \n" ;
				}
				else {nbr_erreur++;
					resultat = line + " :  erreur syntaxique ";
				}
	...
	public static boolean Start_program(String line) {
		  int nbr = 1;
	 ...
	 public static boolean Int_Number(String line) {
	 ...
	 public static boolean Real_Number(String line) {
	 ...
	 public static boolean Give(String line) {
	 ...
	 public static boolean ShowMes(String line) {
	 ...
	 public static boolean S(String line) {
	 ...
	 public static boolean End_program(String line) {
